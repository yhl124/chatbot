document.addEventListener('DOMContentLoaded', function() {
	console.log(policyStatistics);
	
	var colors = ['#90CAF9', '#9575CD', '#BBDEFB', '#D1C4E9', '#673AB7'];
    var dataWithColors = Object.keys(policyStatistics).map((key, index) => {
        return {
            y: policyStatistics[key],
            color: colors[index % colors.length] // 색상을 순환하여 지정
        };
    });
	...
	Highcharts.chart('bargraph', {
	    ...
	    xAxis: {
	        ...
	        categories: Object.keys(policyStatistics),
	        crosshair: true,
	        accessibility: {
